We built an interactive course scheduling web application using Ruby on Rails that would serve as an interface among an institution's registrar, instructors/faculty, and students.
